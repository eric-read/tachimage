...
template<typename T>
void cropBitmap(
        T *pixels, uint32_t sourceWidth, uint32_t left, uint32_t top, uint32_t width, uint32_t height
) {
...
void cropBitmap_ARGB_8888(
        void *pixels, uint32_t sourceWidth, uint32_t left, uint32_t top, uint32_t width, uint32_t height
) {
    cropBitmap((uint32_t *) pixels, sourceWidth, left, top, width, height);
}

void cropBitmap_RGB_565(
        void *pixels, uint32_t sourceWidth, uint32_t left, uint32_t top, uint32_t width, uint32_t height
) {
